...
#+filetags: core
* TODO ffi [0/10]                                                  :lisp:ffi:
:LOGBOOK:
- State "TODO"       from              [2024-08-10 Sat 22:20]
:END:
** WIP rocksdb merge-operator callbacks                             :rocksdb:
...
:END:
** WIP rocksdb compactionfilter callbacks                           :rocksdb:
DEADLINE: <2024-08-18 Sun> SCHEDULED: <2024-08-16 Fri>
:LOGBOOK:
- State "TODO"       from              [2024-08-14 Wed 21:50]
- State "WIP"        from "TODO"       [2024-08-14 Wed 21:50]
:END:
** WIP rocksdb comparator callbacks                                 :rocksdb:
