...
; compilation unit finished
;   Undefined functions:
;     RDB::CURSOR-GET-BOTH-BUFFERED RDB::CURSOR-MOVE-BUFFERED RDB::CURSOR-SET-BUFFERED RDB::DB-CURSOR RDB::DB-CURSOR-MOVE-BUFFERED RDB::DB-CURSOR-PGET-BOTH-BUFFERED RDB::DB-CURSOR-PMOVE-BUFFERED RDB::DB-CURSOR-PSET-BUFFERED RDB::DB-CURSOR-SET-BUFFERED RDB::DB-DELETE-BUFFERED RDB::DB-DELETE-KV-BUFFERED RDB::DB-GET-KEY-BUFFERED RDB::DB-PUT-BUFFERED RDB::DUP-BTREES RDB::INDEX-TABLE-ASSOC CRY/TLS::SSL-CHECK-VERIFY-P NET/SRV/HTTP::SSL-STREAM-X509-CERTIFICATE CRY/TLS::VERIFY-HOSTNAME
;   Undefined variables:
;     CRY/TLS::*DEFAULT-BUFFER-SIZE* CRY/TLS::*DEFAULT-CIPHER-LIST* SYN/CLI:*GEN-CLI* CRY/TLS::*MAKE-SSL-CLIENT-STREAM-VERIFY-DEFAULT* ORGAN/GRAPH:*ORG-GRAPH-FILES* ORGAN/CLI:*ORGAN-CLI* POD::*POD-CLI* RDB/CLI:*RDB-CLI* VC/CLI:*VC-CLI*
