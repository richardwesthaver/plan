...
#+infojs_opt: toc:t home:https://compiler.company up:./
#+OPTIONS: num:nil d:t prop:t toc:nil
#+ARCHIVE: ../../archive/plan.org::** core
#+filetags: core
* PROJECT ffi v0.1.0 [1/8]                                         :lisp:ffi:
:PROPERTIES:
...
:END:
** PROJECT rocksdb v0.1.0 [4/7]                                     :rocksdb:
:PROPERTIES:
...
:END:
**** LINK [[file:/usr/local/include/rocksdb/c.h::/* Write batch */]]
:PROPERTIES:
...
- State "WIP"        from "TODO"       [2024-08-14 Wed 21:50]
CLOCK: [2024-08-18 Sun 18:51]--[2024-08-18 Sun 19:46] =>  0:55
...
- State "TODO"       from              [2024-08-18 Sun 20:44]
:END:
*** TEST define-merge-operator                                        :macro:
:PROPERTIES:
...
#+begin_src lisp :package rocksdb
...
* PROJECT cli/clap v0.2.0 [1/6]                                    :lisp:cli:
:PROPERTIES:
...
* PROJECT organ 0.2 [0/2]                                        :lisp:organ:
:PROPERTIES:
...
- State "PROJECT"    from "TODO"       [2024-08-18 Sun 16:19]
:END:
* PROJECT skel 0.2 [1/4]                                          :lisp:skel:
:PROPERTIES:
...
:END:
** TODO implement vm
SCHEDULED: <2024-08-23 Fri> DEADLINE: <2024-08-25 Sun>
:PROPERTIES:
