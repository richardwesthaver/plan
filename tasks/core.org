...
:END:
need to be able to sort REQUIRE slots in components (specifically systems)
...
:PROPERTIES:
:ID:       6dc49cf7-f024-4b9b-a149-6e60934a6918
:CREATED:  <2025-11-21 Fri 20:52>
:END:
:LOGBOOK:
- State "TODO"       from              [2025-11-21 Fri 20:52]
- State "DONE"       from "TODO"       [2026-01-20 Tue 22:26]
:END:
#+begin_example
; compilation unit finished
;   Undefined functions:
...
*** IO
:PROPERTIES:
:ID:       22be6e84-6690-47c4-acd9-274ad81ef058
:CREATED:  <2025-12-30 Tue 22:26>
:END:
...
*** Caching
:PROPERTIES:
:ID:       21961225-6451-4cd6-8b03-012fa390793e
:CREATED:  <2025-12-30 Tue 22:30>
:END:
...
*** System Methods
:PROPERTIES:
:ID:       588236c6-b97a-4960-aa57-8802229932a2
:CREATED:  <2025-12-30 Tue 22:33>
:END:
- multi-threaded by default (dynamic)
- similar to =define-tensor-method= but for parallel ops
- may want to start with something like =async-method=
  - compatible with =defmethod=?
  - can do something fancy in the defgeneric maybe (build up the task/job prototypes)
- without async, _execute immediately_ do not create tasks/jobs, but respect the cache
- maybe /always/ return STATUS?
**** System Ops
:PROPERTIES:
:ID:       18861e3c-3ef7-4ed8-a88b-8b463c9ef35a
:CREATED:  <2025-12-30 Tue 22:40>
:END:
- always operates on a single task, fed by the session scheduler
- guaranteed to be called when a system method is called with =:async
  t= (default)
- updates and returns the STATUS slot of the received task
...
- module methods?
  - unsure if we want to include them in the system session or have
    them implicitly memoized.
...
:PROPERTIES:
:ID:       877d4467-35d6-44c3-9d4f-3608bfb16011
:CREATED:  <2025-11-20 Thu 22:53>
:END:
:LOGBOOK:
- State "TODO"       from              [2025-11-20 Thu 22:53]
- Note taken on [2025-12-02 Tue 21:00] \\
  may not be as necessary as I thought, letv* and lety get us a long
  way. we should come back to this for transforms and other sorts of
  optimizations. maybe hash-cache too.
- State "HOLD"       from "TODO"       [2025-12-02 Tue 21:01]
- State "DONE"       from "HOLD"       [2025-12-30 Tue 22:54]
:END:
- probably going in prim
- NOTE: destructuring-case actually helps quite a lot with this, but
  requires a significant amount of nesting to accomplish something
  much more terse in MATCH syntax. should also be able to leverage
  switch
- pattern matching engine isn't something that I want to explicitly
  build into std
  - [2025-12-30 Tue] but kinda did anyway.. see std/macs:match
...
- State "HOLD"       from "TODO"       [2025-12-02 Tue 20:59] \\
  low prio
:END:
** DONE with-memoization
:PROPERTIES:
:ID:       eebb1d8d-3784-4d9d-8ab8-083c72dca881
:CREATED:  <2025-11-29 Sat 16:17>
:END:
:LOGBOOK:
- State "FIXME"      from              [2025-11-29 Sat 16:17]
- State "DONE"       from "FIXME"      [2025-11-29 Sat 18:26]
- Note taken on [2025-11-29 Sat 18:26] \\
  using CDR where we wanted CADR, rebound an existing GENSYM (ARG)
:END:
- definitely not working as intended, see =OBJ/TENSOR::*SPECIALIZER-TABLE*=
** DONE sap-ref
:PROPERTIES:
:ID:       c6fb6eea-351e-43d2-ac1c-9a772acf9360
:CREATED:  <2025-12-02 Tue 20:56>
:END:
:LOGBOOK:
- State "TODO"       from              [2025-12-02 Tue 20:56]
- State "DONE"       from "TODO"       [2025-12-30 Tue 22:54]
:END:
- some errors being uncovered with dispatch
  - check SAP-REF-DOUBLE vs SAP-REF as well as SETF expansions
** TBD ignorable-gensyms
:PROPERTIES:
:ID:       80763d08-e3fc-47e7-b5d8-4414f6d82ac9
:CREATED:  <2026-01-01 Thu 18:29>
:END:
:LOGBOOK:
- State "TBD"        from              [2026-01-01 Thu 18:29]
:END:
- only a handful of usecases to work acround letv and friends. may
  want to elect to just PARSE-BODY correctly or otherwise apply
  declarations (ignorable being ignored in deeply nested macros, see
  MATH/GRAPH:GRAPHFIB)
** TODO Standard Loop Paths
:PROPERTIES:
:ID:       0eeee1a4-84cf-4e40-9ab9-50a8c0f810c6
:CREATED:  <2025-11-29 Sat 16:00>
:END:
:LOGBOOK:
- State "TODO"       from              [2025-11-29 Sat 16:00]
:END:
- index
- elt
- queues..
- probably want to register and manage these somehow.. maybe
  separate/backup lisp universe
- [[id:04fdde4f-427c-47b5-8394-5b5365ede249][incorporate sb-cltl2 generators/iterators into STD/PIPE]]
