...
:END:
** PROJECT rocksdb v0.1.0                                           :rocksdb:
:LOGBOOK:
...
*** WIP compactionfilter callbacks                                  :rocksdb:
...
- State "WIP"        from "TODO"       [2024-08-14 Wed 21:50]
:END:
*** WIP comparator callbacks                                        :rocksdb:
...
* TODO cli/clap v0.2.0 [1/6]                                       :lisp:cli:
:LOGBOOK:
...
** TODO comp/org capture templates                                    
:LOGBOOK:
